...
class PopularListingPage extends StatelessWidget {
  final List<Post> cartItems;

  PopularListingPage({Key key, this.cartItems}) : super(key: key);
  ...
  @override
    Widget build(BuildContext context) {
      return BlocProvider(
        create: (context) =>
            PostBloc(httpClient: http.Client())..add(FetchPopularListingEvent(3, 1, 'Popular Sales', this.cartItems)),
        child: HomePage(),
      ); 
    }
}
